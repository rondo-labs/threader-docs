...
Get up and running with Threader in 5 minutes.

## 1. Create a Project

Launch Threader and create a new project. Each project is stored as a `.threader` file (SQLite-based).
...
- Each event type has a dedicated shortcut
