...
- Add arrows to show runs or passing lanes
- Draw lines to explain spacing
- Mark zones or reference shapes
- Add text labels during review preparation
- Attach drawings to clips for presentation
